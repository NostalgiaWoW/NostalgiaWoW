...
# Created: October 22, 2018 at 7:15:41 PM CDT
...
) ENGINE=MyISAM AUTO_INCREMENT=57007 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Condition System';
...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2632175 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
...
CREATE TABLE `creature_ai_scripts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=98800627 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='EventAI Scripts';
...
CREATE TABLE `creature_ai_summons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=104 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='EventAI Summoning Locations';
...
CREATE TABLE `creature_template` (
  ...
  `aggroRadius` tinyint(3) NOT NULL DEFAULT '0',
...
CREATE TABLE `game_tele` (
  ...
  `name` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=757 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
...
CREATE TABLE `gameobject` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4115311 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
