...
SET v = (SELECT COUNT(*) FROM `migrations` WHERE `id`='20200409030000');
IF v=0 THEN
INSERT INTO `migrations` VALUES ('20200409030000');
...
CREATE TABLE `logs_virus_event` (
  ...
  `cured_npc` int(11) unsigned NOT NULL DEFAULT '0',
  `cured_player` int(11) unsigned NOT NULL DEFAULT '0',
