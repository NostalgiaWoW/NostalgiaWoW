            ...
            if (m_uiBlessingEventTimer <= diff)
            {
                ...
                switch (m_uiTick)
                {
                    case 0:
                        ...
                        if (Creature* herald = m_creature->SummonCreature(NPC_HERALD_THRALL, -462.404f, -2637.68f, 96.0656f, 5.8606f, TEMPSUMMON_TIMED_DESPAWN, WARCHIEF_BLESSING_COOLDOWN))
                        {
                            m_HeraldGuid = herald->GetObjectGuid();
                            herald->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_PASSIVE);
                        }
                    ...
                    case 1:
                        ...
                        if (Unit* herald = ObjectAccessor::GetUnit(*me, m_HeraldGuid))
                        {
                            herald->HandleEmote(EMOTE_ONESHOT_SHOUT);
                            herald->MonsterYellToZone(YELL_WARCHIEF_BLESSING_1);
                        }
                    ...
                    case 2:
                        ...
                        {
                            herald->HandleEmote(EMOTE_ONESHOT_SHOUT);
                            herald->MonsterYellToZone(YELL_WARCHIEF_BLESSING_3);
                        }
                    ...
                    case 3:
                        ...
                        if (Unit* herald = ObjectAccessor::GetUnit(*me, m_HeraldGuid))
                            herald->CastSpell(herald, SPELL_WARCHIEF_BLESSING, true);
