...
static const WarEffort SharedObjectives[5] =
{
    ...
    {2840,  25000,  2840,  "Copper Bar", WAREFFORT_BAR},
    {8831,  14500,  8831,  "Purple Lotus", WAREFFORT_HERBS},
    {4304,  61000,  4304,  "Thick Leather", WAREFFORT_SKINS},
    {6887,  14500,  6887,  "Spotted Yellowtail", WAREFFORT_COOKING},
    {14529, 215000, 14529, "Runecloth Bandage", WAREFFORT_BANDAGES}
...
static const WarEffort AllianceObjectives[10] =
{
    ...
    {8836,  11000,  8836,   "Arthas' Tears", WAREFFORT_HERBS},
    {3820,  3000,  3820,   "Stranglekelp", WAREFFORT_HERBS},
    {2318,  20000, 2318,   "Light Leather", WAREFFORT_SKINS},
    {2319,  18000, 2319,   "Medium Leather", WAREFFORT_SKINS},
    {12210, 3500,  12210,  "Roast Raptor", WAREFFORT_COOKING},
    {5095,  3500,  5095,   "Rainbow Fin Albacore", WAREFFORT_COOKING},
    {1251,  100000, 1251,   "Linen Bandage", WAREFFORT_BANDAGES},
    {6450,  100000, 6450,   "Silk Bandage", WAREFFORT_BANDAGES}
...
static const WarEffort HordeObjectives[10] =
{
    ...
    {3576,  8000,  3576,   "Tin Bar", WAREFFORT_BAR},
    {3860,  13750,  3860,   "Mithril Bar", WAREFFORT_BAR},
    {2447,  36500,  2447,   "Peacebloom", WAREFFORT_HERBS},
    {4625,  4500,  4625,   "Firebloom", WAREFFORT_HERBS},
    {4234,  27000,  4234,   "Heavy Leather", WAREFFORT_SKINS},
    {8170,  60000,  8170,   "Rugged Leather", WAREFFORT_SKINS},
    {12209, 3000,  12209,  "Lean Wolf Steak", WAREFFORT_COOKING},
    {13935, 2150,  13935,  "Baked Salmon", WAREFFORT_COOKING},
    {3530,  25000, 3530,   "Wool Bandage", WAREFFORT_BANDAGES},
    {8544,  34000, 8544,   "Mageweave Bandage", WAREFFORT_BANDAGES}
...
{
    { -8209.303f, 1500.973f, 148.0f, 0.0f, 0}, // Flight position for dragons
...
bool GOHello_go_crystalline_tear(Player* pPlayer, GameObject* pGo)
{
	if (pPlayer->GetQuestStatus(QUEST_LONG_FORGOTTEN_MEMORIES) == QUEST_STATUS_INCOMPLETE)
	{
		pPlayer->AreaExploredOrEventHappens(QUEST_LONG_FORGOTTEN_MEMORIES);
		return true;
	}
	return false;
}
...
void AddSC_silithus()
{
    ...
    */
	...
	pNewScript->pGOHello = &GOHello_go_crystalline_tear;
    pNewScript->RegisterSelf();
