...
public:
    ...
    bool DoTransmog(Player* player, Item* pItemToTransmog, Item* pItemTransmog, bool ignoreCheck = false, bool saveToDb = true);
    bool _DoTransmog(Player* player, Item* pItemToTransmog, Item* pItemTransmog, bool ignoreCheck = false);
