...
void SendDefaultMenu_BoatTeleportNPC(Player* player, Creature* _Creature, uint32 action)
{
	switch (action)
	{
		...
		case 93:
			player->CLOSE_GOSSIP_MENU();
			player->TeleportTo(1, -11854.88, -4579.41, 0.26, 6.09f);
			break;
		case 94:
			player->CLOSE_GOSSIP_MENU();
...
enum
{
	...
	QUEST_ONY_HORDE = 30153,
	QUEST_ONY_ALLIANCE = 30152,
	QUEST_NEF_HORDE = 30157,
	QUEST_NEF_ALLIANCE = 30156,
	QUEST_WARCHIEF = 30150,
