...
class MANGOS_DLL_SPEC CreatureAI
{
    public:
		...
		*/
        ...
        virtual void GetData(uint32 dataIndx, uint32& Data) {}
        virtual void GetData(uint32 dataIndx, float& Data) {}

        virtual void SetData(uint32 dataIndx, uint32 Data) {}
        virtual void SetData(uint32 dataIndx, float Data) {}
