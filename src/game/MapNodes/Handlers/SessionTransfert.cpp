...
void NodeSession::LoadSession(WorldSession* wsess)
{
    ...
    sessInfos.localIp = wsess->GetLocalAddress();
...
void NodeSession::HandleLoadSession(WorldPacket& pkt)
{
    ...
    WorldSession* wsess = new WorldSession(loadInfos.accountId, NULL, loadInfos.sec, loadInfos.muteTime, loadInfos.locale, loadInfos.localIp, loadInfos.remoteIp);
