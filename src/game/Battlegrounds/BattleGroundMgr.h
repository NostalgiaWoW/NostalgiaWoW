...
class BattleGroundMgr
{
    public:
        ...
        void SetUpdateInterval(int32 InUpdateInterval);
        ...
        void RemovePlayerFromQueues(Player* player, int8_t activeSlot = -1, bool logout = false);
    private:
        ...
        //time in msec for force update BGQueues. 0 - disabled
        int32 m_UpdateInterval;
        int32 m_UpdateIntervalTimer;
};
