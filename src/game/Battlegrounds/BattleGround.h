...
const char* GetBattleGroundBracketIdString(BattleGroundBracketId value);
...
class BattleGround
{
    ...
    public:
        ...
        virtual SpellCastResult CheckSpellCast(Player* caster, SpellEntry const* spell, SpellCastTargets const* targets) { return SPELL_CAST_OK; }
