...
void BattleGroundAV::Reset()
{
	...
	m_RepCommander		  = (isBGWeekend) ? BG_AV_REP_CAPTAIN_HOLIDAY		: BG_AV_REP_CAPTAIN;
...
SpellCastResult BattleGroundAV::CheckSpellCast(Player* caster, SpellEntry const* spell, SpellCastTargets const* targets)
{
    switch (spell->Id)
    {
