...
class SessionAnticheat final : public SessionAnticheatInterface
{
    ...
    public:
        ...
        virtual void SendPlayerLoginInfo(ChatHandler*) const;
    ...
    private:
        ...
        std::unique_ptr<ElysiumAnticheat::Movement> _movementData;

        // shared with antispam worker thread loop
        std::shared_ptr<ElysiumAnticheat::Antispam> _antispam;
