...
INSTANTIATE_SINGLETON_1(ElysiumAnticheat::AnticheatConfig);
...
static_assert(sizeof(sCheatTypeNames) / sizeof(sCheatTypeNames[0]) == ElysiumAnticheat::CheatType::CHEATS_COUNT,
