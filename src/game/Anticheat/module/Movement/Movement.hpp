...
class Movement
{
    private:
        ...
        // this is somewhat redundant with Unit::GetXZFlagBasedSpeed() but uses our understanding of what the client should have for speed
        float GetXZFlagBasedClientSpeed(uint32 moveFlags) const;
