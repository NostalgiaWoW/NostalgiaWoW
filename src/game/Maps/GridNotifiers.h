...
namespace MaNGOS
{
    ...
    */
    ...
    // Select nearest attackable hostile unit
    class NearestAttackableHostileUnitInObjectRangeCheck
    {
    public:
        NearestAttackableHostileUnitInObjectRangeCheck(WorldObject const* obj, Unit const* funit, float range) : i_obj(obj), i_funit(funit), i_range(range) {}
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Unit* u)
        {
            if (i_obj->IsWithinDistInMap(u, i_range) && i_funit->IsValidAttackTarget(u) &&
    ...
    private:
        ...
        // prevent clone this object
        NearestAttackableHostileUnitInObjectRangeCheck(NearestAttackableHostileUnitInObjectRangeCheck const&);
    };
    ...
    public:
        ...
        bool operator() (GameObject* pGo)
        {
            if (m_pObject->IsWithinDist(pGo, m_fRange, false))
                return true;
