...
enum AccountFlags
{
    ...
    ACCOUNT_FLAG_HIDDEN                   = 0x8,
    ACCOUNT_FLAG_SHOW_SUSPICIOUS          = 0x10,
    ACCOUNT_FLAG_ALWAYS_DESERTER_ON_LEAVE = 0x20,
    ACCOUNT_FLAG_PACKETLOG                = 0x40,
    ACCOUNT_FLAG_PREMIUM                  = 0x80,
};
...
class MANGOS_DLL_SPEC WorldSession
{
    ...
    public:
        WorldSession(uint32 id, WorldSocket *sock, AccountTypes sec, time_t mute_time, LocaleConstant locale, const std::string& local_ip, const std::string& remote_ip);
        ~WorldSession();
        ...
        void SetPacketLogging(bool value);
        ...
        bool AdditionalAllowPacket(uint16 opcode);
        ...
        void HandleChatFilteredOpcode(WorldPacket& recvPacket);
    ...
    private:
        ...
        std::unique_ptr<PacketLog> _packetLog;

        // anticheat
        uint32 _lastAnticheatUpdate;
        ...
        uint32 _extraFloodPacketsOptions[835][2];
