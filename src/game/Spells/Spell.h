...
class SpellCastTargets
{
    public:
        ...
        void getDestination(Position& OutPos) const { OutPos.set(m_destX, m_destY, m_destZ); }
...
class Spell
{
    ...
    public:
        ...
        static void MANGOS_DLL_SPEC SendCastResult(Player* caster, SpellEntry const* spellInfo, SpellCastResult result, uint32* param1 = nullptr, uint32* param2 = nullptr);
    ...
    protected:
        ...
        std::array<std::vector<ExecuteLogInfo>, MAX_EFFECT_INDEX>  m_executeLogInfo;
