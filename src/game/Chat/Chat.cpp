...
#include "module/AnticheatChatCommands.h"
    ...
    {
        { NODE, "info",     SEC_ADMINISTRATOR, true,  &ChatHandler::HandleAnticheatInfoCommand,             "", nullptr },
    ...
    static ChatCommand accountSetCommandTable[] =
    {
        ...
        { NODE, "packetlog",      SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleAccountSetPacketLogCommand, "", nullptr },
    ...
    static ChatCommand scanCommandTable[] =
    {
        { NODE, "multibox",       SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleScanMultiboxCommand,        "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { NODE, "setinstancedata",SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleDebugSetInstanceDataCommand,     "", nullptr },
        { NODE, "inactivityData", SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleDebugInactivityDataCommand,      "", nullptr },
        { NODE, "crash",          SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleDebugCrashCommand,               "", nullptr },
        { NODE, "showleaks",      SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleDebugShowLeaksCommand,           "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                                "", nullptr }
    };
    ...
    static ChatCommand instanceCommandTable[] =
    {
        ...
        { NODE, "selfunbind",     SEC_GAMEMASTER,     false, &ChatHandler::HandleInstanceUnbindCommand,      "", nullptr }, //It's the same function as 'unbind', the differents in SQL command registration
    ...
    static ChatCommand lookupAccountCommandTable[] =
    {
        ...
        { NODE, "iplist",         SEC_GAMEMASTER,     true,  &ChatHandler::HandleLookupAccountIpListCommand,    "", nullptr },
    ...
    static ChatCommand loyaltypointsCommandTable[] = {
            {NODE, "add",   SEC_ADMINISTRATOR, true,  &ChatHandler::HandleLoyaltyPointsAddCommand, "Adds loyalty points to either the target player or yourself.", nullptr},
            {MSTR, nullptr, 0,                 false, nullptr,                                     "",                                                             nullptr}
    };
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { MSTR, "antispam_client",             SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadClientAntispamCommand,          "", nullptr },
    ...
    static ChatCommand serverCommandTable[] =
    {
		...
		{ NODE, "memcompact",     SEC_ADMINISTRATOR,  true, &ChatHandler::HandleServerMemcompactCommand,	"Deallocate unused memory. Can be used only if server use Intel TBB", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    {
        { NODE, "status",            SEC_GAMEMASTER,           true , &ChatHandler::HandleBGStatusCommand,         "", nullptr},
        ...
        { NODE, "randomizer",        SEC_ADMINISTRATOR,        true , &ChatHandler::HandleBGRandomizerCommand,     "", nullptr},
        { NODE, "updateInterval",    SEC_ADMINISTRATOR,        true , &ChatHandler::HandleBGUpdateIntervalCommand, "", nullptr },
    ...
    static ChatCommand chathookCommandTable[] =
    {
        { NODE, "all",              SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleChathookAllCommand,        "", nullptr },
        { NODE, "clear",            SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleChathookClearCommand,      "", nullptr },
        { NODE, "group",            SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleChathookGroupCommand,      "", nullptr },
        { NODE, "bg",               SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleChathookGroupCommand,      "", nullptr },
        { NODE, "raid",             SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleChathookGroupCommand,      "", nullptr },
        { NODE, "guild",            SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleChathookGuildCommand,      "", nullptr },
        { NODE, "whisper",          SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleChathookWhisperCommand,    "", nullptr },
        { MSTR, nullptr,              0,                    false, nullptr,                                        "", nullptr }
    };

    static ChatCommand easterRabbitCommandTable[] =
    {
        { NODE, "enragetime",            SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitEnrageTime,            "", nullptr },
        { NODE, "calmdowntime",          SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitCalmdownTime,          "", nullptr },
        { NODE, "warntime",              SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitWarnTime,              "", nullptr },
        { NODE, "visionradius",          SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitVisionRadius,          "", nullptr },
        { NODE, "changeorientationtime", SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitChangeOrientationTime, "", nullptr },
        { NODE, "enrageflamestriketime", SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitEnrageFlamestrikeTime, "", nullptr },
        { NODE, "burnauradamagepercent", SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitBurnDamage, "", nullptr },
        { NODE, "burnauraradius",        SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitBurnRadius, "", nullptr },
        { NODE, "aenrage",                SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitEnrage,                "", nullptr },
        { NODE, "zcalmdown",              SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitCalmdown,              "", nullptr },
        { MSTR, nullptr,              0,                    false, nullptr,                                                     "", nullptr }
    };

    static ChatCommand easterCommandTable[] =
    {
        { NODE, "worldeggspawntime", SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterWorldEggSpawnTime,    "", nullptr },
        { NODE, "rabbitegglaytime",  SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterRabbitLayEggTime,     "", nullptr },
        { NODE, "bossrabbit",        SEC_ADMINISTRATOR,      false,  nullptr,    "", easterRabbitCommandTable },
        { NODE, "pinfo",             SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterPInfo,                "", nullptr },
        { NODE, "info",              SEC_ADMINISTRATOR,      false,  &ChatHandler::HandleEasterInfo,                 "", nullptr },
        { MSTR, nullptr,              0,                    false, nullptr,                                          "", nullptr }
    };

    static ChatCommand suspiciousCommandTable[] =
    {
        { NODE, "enable",               SEC_ADMINISTRATOR,      true,  &ChatHandler::HandleSuspiciousEnable,               "", nullptr },
        { NODE, "movementenable",       SEC_ADMINISTRATOR,      true,  &ChatHandler::HandleSuspiciousMovementEnable,       "", nullptr },
        { NODE, "movementdetectvalue",  SEC_ADMINISTRATOR,      true,  &ChatHandler::HandleSuspiciousMovementDetectValue,  "", nullptr },
        { NODE, "fishingenable",        SEC_ADMINISTRATOR,      true,  &ChatHandler::HandleSuspiciousFishingEnable,        "", nullptr },
        { NODE, "killednpcenabled",     SEC_ADMINISTRATOR,      true,  &ChatHandler::HandleSuspiciousKilledNPC,            "", nullptr },
        { NODE, "notify",               SEC_ADMINISTRATOR,      false, &ChatHandler::HandleSuspiciousNotify,               "", nullptr },
        { NODE, "fishers",              SEC_ADMINISTRATOR,      false, &ChatHandler::HandleSuspiciousFishers,              "", nullptr },
        { MSTR, nullptr,                0,                      false, nullptr,                                             "", nullptr }
    };

    static ChatCommand sanctionCommandTable[] =
    {
        { NODE, "deserter",             SEC_MODERATOR,          false, &ChatHandler::HandleSanctionDeserter,                "", nullptr },
        { MSTR, nullptr,                0,                      false, nullptr,                                             "", nullptr }
    };
    ...
    {
        { NODE, "list",                 SEC_ADMINISTRATOR,      false, &ChatHandler::HandleVIPListAuras,                    "", nullptr },
        { NODE, "aura",                 SEC_PLAYER,             false, &ChatHandler::HandleVIPAura,                         "", nullptr },
        { NODE, "unaura",               SEC_PLAYER,             false, &ChatHandler::HandleVIPUnAura,                       "", nullptr },
        { MSTR, nullptr,                0,                      false, nullptr,                                             "", nullptr }
    };
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { NODE, "anticheat",      SEC_ADMINISTRATOR,  true, nullptr,                                           "", anticheatCommandTable },
        ...
        { NODE, "loyaltypoints", SEC_ADMINISTRATOR, true, nullptr, "Manage Elysium loyalty points", loyaltypointsCommandTable },
        ...
        { MSTR, "scan",           SEC_ADMINISTRATOR,  true, nullptr,                                           "", scanCommandTable      },
        ...
        { NODE, "chathook",       SEC_ADMINISTRATOR,  false, nullptr,                                        "", chathookCommandTable },
        ...
        { NODE, "queuearena",     SEC_PLAYER,         false, &ChatHandler::HandleQueueArenaCommand,                  "", nullptr },
...
bool ChatHandler::isValidChatMessage(const char* message)
{
    ...
    */
    ...
    if (sWorld.getConfig(CONFIG_UINT32_CHAT_STRICT_LINK_CHECKING_SEVERITY) < 3)
    {
        ...
        std::istringstream l_Reader(message);

        while (!l_Reader.eof())
        {
            if (validSequence == validSequenceIterator)
                l_Reader.ignore(255, '|');
            else if (l_Reader.get() != '|')
            {
...
void ChatHandler::ExtractOptFirstArg(char* p_Args, char** p_Arg1, char** p_Arg2)
{
    char* p1 = strtok(p_Args, " ");
    char* p2 = strtok(NULL, " ");
...
const char* ChatHandler::ToString(bool bValue)
{
...
bool ChatHandler::ShouldLog()
{
    if (m_session != nullptr)
    {
        if (m_session->GetAccountFlags() & ACCOUNT_FLAG_HIDDEN)
            return false;
    }
    return true;
}
