...
class MANGOS_DLL_SPEC ChatHandler
{
    public:
        ...
        //Giperion Elysium: Return Yes if true, No - otherwise
        static const char* ToString(bool bValue);
        ...
        enum EasterDataIndexes
        {
            ...
            VisionRadius = 5,
            OrientationTime = 6,
            EnrageFlamestrikeTime = 7,
            BurnAuraDamagePercent = 8,
            BurnAuraDamageRadius = 9
        };
    protected:
        ...
        bool HandleDebugSetInstanceDataCommand(char*);
        bool HandleDebugInactivityDataCommand(char*);
        ...
        bool HandleChathookGroupCommand(char* args);
        bool HandleChathookGuildCommand(char* args);
        bool HandleChathookWhisperCommand(char* args);
        bool HandleChathookAllCommand(char* args);
        bool HandleChathookClearCommand(char* args);
        bool ChathookHelper(char* args, ChathookTarget targetType);
        // Clean characters
        ...
        bool HandleBGRandomizerCommand(char* args);
        bool HandleBGUpdateIntervalCommand(char* args);
        // Spell
        ...
        // Reload
        bool HandleReloadClientAntispamCommand(char *args);
        ...
        bool HandleAccountSetPacketLogCommand(char* args);
        ...
        bool HandleScanMultiboxCommand(char* args);
        ...
        bool HandleDebugCrashCommand(char* args);
        bool HandleDebugShowLeaksCommand(char* args);
        ...
        */
        ...
        ///EASTER EVENT TEMP COMMANDS


        bool HandleEasterWorldEggSpawnTime(char* args);
        bool HandleEasterRabbitLayEggTime(char* args);
        bool HandleEasterPInfo(char* args);
        bool HandleEasterInfo(char* args);

        bool HandleEasterRabbitEnrageTime(char* args);
        bool HandleEasterRabbitCalmdownTime(char* args);
        bool HandleEasterRabbitWarnTime(char* args);
        bool HandleEasterRabbitVisionRadius(char* args);
        bool HandleEasterRabbitChangeOrientationTime(char* args);
        bool HandleEasterRabbitEnrageFlamestrikeTime(char* args);
        bool HandleEasterRabbitEnrage(char* args);
        bool HandleEasterRabbitCalmdown(char* args);
        bool HandleEasterRabbitBurnRadius(char* args);
        bool HandleEasterRabbitBurnDamage(char* args);
        ...
        ///Sanction commands
        bool HandleSanctionDeserter(char* args);

        ///VIP commands
        bool HandleVIPListAuras(char* args);
        ...
        bool HandleLookupAccountIpListCommand(char * args);
		...
		bool HandleServerMemcompactCommand(char* args);
        ...
        bool HandleAccInfoCommand(char* args);
		...
		bool HandleMorphScannerCommand(char* args);
        ...
        /* Loyalty Points */
        bool HandleLoyaltyPointsAddCommand(char* args);
...
#include "module/AnticheatChatCommandsFunctions.h"
        ...
        void ExtractOptFirstArg(char * p_Args, char ** p_Arg1, char ** p_Arg2);
        ...
        struct DeletedInfo
        {
            ...
            uint32      characterLevel;                     ///< the character level
            std::string characterClass;                     ///< the character class string
