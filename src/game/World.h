...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_MIN_GOLD_FOR_SURPRISE_BOX,
    CONFIG_UINT32_MAX_GOLD_FOR_SURPRISE_BOX,
    CONFIG_UINT32_MIN_LVL_FOR_SURPRISE_BOX,
    CONFIG_UINT32_AUTOBROADCAST_CENTER,
    CONFIG_UINT32_AUTOBROADCAST_INTERVAL,
    CONFIG_UINT32_AREA_EXPLORATION_TIME_THRESHOLD,
    CONFIG_UINT32_PREMIUM_SPEC_CHANGE_DISCOUNT,
    CONFIG_UINT32_PREMIUM_ITEMS_REPAIR_DISCOUNT,
    CONFIG_UINT32_PREMIUM_HEARTHSTONE_CD_REDUCTION,
    CONFIG_UINT32_PREMIUM_HERBALISM_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_MINING_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_SKINNING_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_ALCHEMY_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_BLACKSMITHING_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_ENCHANTING_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_ENGINEERING_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_LEATHERWORKING_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_TAILORING_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_COOKING_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_FIRST_AID_SKILL_MOD,
    CONFIG_UINT32_PREMIUM_FISHING_SKILL_MOD,
...
enum eConfigInt32Values
{
    ...
    CONFIG_INT32_XP_DIVIDE_THRESHOLD = 1,
    CONFIG_INT32_XP_LOG_SAVE_PERIOD = 2,
...
enum eConfigFloatValues
{
	...
	CONFIG_FLOAT_POPULATION_MULTIPLIER = 77
};
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_SURPRISE_BOX,
    CONFIG_BOOL_AUTOBROADCAST_USE_CONST_TIMER,
    CONFIG_BOOL_ENABLE_CLIENT_REGEX,
    CONFIG_BOOL_XP_DIVIDE_IN_DUNGEON,
    CONFIG_BOOL_XP_DIVIDE_IN_RAID,
    CONFIG_BOOL_XP_DIVIDE_IN_WORLD,
    CONFIG_BOOL_WEB_DATABASE_ENABLED,
    CONFIG_BOOL_PREMIUM_INSTANT_FLY_ENABLED,
    CONFIG_BOOL_PREMIUM_INSTANT_INGAME_MAIL_ENABLED,
    CONFIG_BOOL_TRANSMOG_ENABLED,
    CONFIG_BOOL_EVENT_CHAT_UNITED,
...
class World
{
    public:
        ...
        std::unordered_map<uint32, WorldSession*> GetSessionsByIp(const std::string ip, bool online = false /*player in world*/);
        ...
        void SendWorldNotification(int32 string_id, ...);
        ...
        std::string GetRestartReason() const { return restartReason; }
        void SetRestartReason(std::string reason) { restartReason = reason; }
        ...
        std::string const& GetIPForPage(size_t idx) const
        {
            ASSERT(idx < m_CharacterPageIPs.size());
            return m_CharacterPageIPs[idx];
        }

        std::vector<std::string> const& GetPageIPs() const { return m_CharacterPageIPs; }
        ...
        **/
        ...
        std::unordered_set<uint32> const& GetVIPVisuals() const { return m_VIPsAllowableVisuals; }
    ...
    private:
        ...
        std::vector<std::string> m_CharacterPageIPs;

        std::unordered_set<uint32> m_VIPsAllowableVisuals;
};
