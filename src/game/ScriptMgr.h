...
public:
    ...
    virtual void GetStatus(ChatHandler& handler);
...
class ScriptMgr
{
    public:
        ...
        void GetQuestInstancesForPlayer(ObjectGuid PlayerGuid, std::vector<std::shared_ptr<QuestInstance>>& OutInstances);
        std::shared_ptr<QuestInstance> GetQuestInstance(ObjectGuid PlayerGuid, uint32 QuestId);
