...
MACRO(_PCH_GET_COMPILE_FLAGS _out_compile_flags)
  ...
  #Commented, because PCH compile flags must be exactly same as library compile flags
  #FOREACH(item ${_directory_flags_type})
  #	STRING(REPLACE "\"" "'" escaped_item ${item})
  #	LIST(APPEND _directory_flags ${escaped_item})
  #ENDFOREACH(item)
...
MACRO(ADD_PRECOMPILED_HEADER _targetName _input)
  ...
  #message("COMMAND ${CMAKE_CXX_COMPILER} -x c++-header -o ${_output} ${_input}")
