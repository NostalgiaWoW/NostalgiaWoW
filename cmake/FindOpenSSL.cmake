...
# Only try searching if the user has not explicitly defined the path
...
if("${OPENSSL_ROOT_DIR}" STREQUAL "OPENSSL_ROOT_DIR-NOTFOUND")
  message(FATAL_ERROR "OpenSSL not found.  Try specifying path manually with -DOPENSSL_ROOT_DIR=...")
endif()

# At this point we know OPENSSL_ROOT_DIR is set and correct
